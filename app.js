...
class User{
  constructor(name,email,desc,mobile){
    this.name = name;
    this.email = email;
    this.desc = desc;
    this.mobile = mobile
  ...
  details(){
    console.log(`${this.name} has an ${this.email} and ${this.desc} and also has a ${this.mobile}`)
  }
}

const rahim = new User('Rohim',"rohim@gmail.com","He is a doctor",23423412)
rahim.details()
// const kohim = new User('Korim',"kohim@gmail.com","He is a farmer",23423464652)


class Modify extends User{
  constructor(name,email,desc,mobile,facebookId){
    super(name,email,desc,mobile)
    this.facebookId = facebookId
  }
  
  details(){
    console.log(`${this.name} has an ${this.email} and ${this.desc} and also has a ${this.mobile} and ${this.facebookId}`)
  }
}

const korim = new Modify('Korim',"kohim@gmail.com","He is a farmer",23423464652,'http://fb.com/hfdssjh/afhsdjhk')
